...
import 'package:clean_app/features/domain/usecases/update_product.dart';
...
Future<void> main() async {
  ...
  const testUpdate = Product(id: 1, name: 'shoe', category: 'leather', price: 40, rating: 4.0, description: 'quality shoe');
